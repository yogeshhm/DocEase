...
<html lang="en">
    <head>
        <title>DocEase Simplified HeatlthCare Acess System || Home Page</title>
                            ...
                            <div class="booking-form">
                                ...
                                <form role="form" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <input type="telephone" name="phone" id="phone" class="form-control" placeholder="Enter Phone Number" minlength="10" maxlength="10">
                                        </div>
